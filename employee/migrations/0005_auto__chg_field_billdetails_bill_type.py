...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'billdetails.bill_type'
        db.alter_column(u'employee_billdetails', 'bill_type', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'billdetails.bill_type'
        db.alter_column(u'employee_billdetails', 'bill_type', self.gf('django.db.models.fields.DateField')())
