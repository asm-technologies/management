...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Billing_Detail.emp_sub_project'
        db.add_column(u'employee_billing_detail', 'emp_sub_project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employee.Sub_Project'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Billing_Detail.emp_sub_project'
        db.delete_column(u'employee_billing_detail', 'emp_sub_project_id')
    ...
    models = {
        u'employee.billing_detail': {
            ...
            'emp_sub_project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['employee.Sub_Project']", 'null': 'True', 'blank': 'True'}),
